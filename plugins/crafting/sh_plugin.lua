...
function RECIPES:Register( tbl )
	...
	if !tbl.ProcessCraftItems then
		function tbl:ProcessCraftItems( player )
			...
			player:EmitSound("fosounds/fix/repairweapon/ui_repairweapon_0"..math.random(1,7)..".mp3")
			...
			if cancarry() then
				...
				nut.util.Notify("You do not have enough capacity in your inventory to do that.", player )
			end
